...
public class Reservation {
        private static Insured insured;
        private Timeslot timeslot;

        private static Map<Insured, Timeslot> reservations;
    ...
    public Reservation(Insured insured,Timeslot timeslot) {
        ...
        static boolean hasReservationForVaccination() {
            return reservations.containsKey(insured);
        }
